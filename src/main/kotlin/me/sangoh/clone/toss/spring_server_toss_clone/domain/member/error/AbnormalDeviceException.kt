 ...
 */
class AbnormalDeviceException private constructor(value: String, errorCode: ErrorCode, vararg args: Any?) :
    InvalidValueException(value, errorCode, *args) {

    companion object: ULog {
        fun of(device: Device): AbnormalDeviceException {
            return AbnormalDeviceException(
